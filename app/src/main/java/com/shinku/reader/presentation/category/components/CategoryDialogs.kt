...
import com.shinku.reader.core.preference.asToggleableState
...
fun ChangeCategoryDialog(
    ...
    if (initialSelection.isEmpty()) {
        AlertDialog(
            onDismissRequest = onDismissRequest,
            confirmButton = {
                com.shinku.reader.presentation.core.components.material.TextButton(
                    onClick = {
                        onDismissRequest()
                        onEditCategories()
                    },
    ...
    AlertDialog(
        ...
        confirmButton = {
            Row {
                com.shinku.reader.presentation.core.components.material.TextButton(onClick = {
                    onDismissRequest()
                    onEditCategories()
                }) {
                ...
                com.shinku.reader.presentation.core.components.material.TextButton(onClick = onDismissRequest) {
                    Text(text = stringResource(MR.strings.action_cancel))
                }
                com.shinku.reader.presentation.core.components.material.TextButton(
                    onClick = {
