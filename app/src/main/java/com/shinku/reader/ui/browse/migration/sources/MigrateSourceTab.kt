package com.shinku.reader.ui.browse.migration.sources
...
import com.shinku.reader.presentation.browse.MigrateSourceScreen
    ...
    return TabContent(
        ...
        actions = persistentListOf(
            AppBar.Action(
                ...
                onClick = {
                    uriHandler.openUri("https://shinku.app/docs/guides/source-migration")
                },
            ),
        ),
