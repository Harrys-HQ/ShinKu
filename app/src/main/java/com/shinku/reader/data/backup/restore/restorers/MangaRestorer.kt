...
import com.shinku.reader.data.backup.models.BackupMergedMangaReference
import com.shinku.reader.data.backup.models.BackupTracking
import com.shinku.reader.exh.EXHMigrations
import com.shinku.reader.data.DatabaseHandler
import com.shinku.reader.data.UpdateStrategyColumnAdapter
import com.shinku.reader.data.manga.MangaMapper
import com.shinku.reader.data.manga.MergedMangaMapper
    ...
    suspend fun updateManga(manga: Manga): Manga {
        handler.await(true) {
            mangasQueries.update(
                ...
                isSyncing = 1,
                lastUpdateError = manga.lastUpdateError,
                notes = manga.notes,
            )
        }
        return manga
