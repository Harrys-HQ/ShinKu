...
import com.shinku.reader.data.backup.create.BackupCreator
...
import com.shinku.reader.data.backup.restore.RestoreOptions
...
import com.shinku.reader.data.sync.service.SyncData
import kotlinx.serialization.json.Json
import kotlinx.serialization.protobuf.ProtoBuf
import logcat.LogPriority
import logcat.logcat
import com.shinku.reader.core.common.util.system.logcat
import com.shinku.reader.data.Chapters
import com.shinku.reader.data.DatabaseHandler
import com.shinku.reader.data.manga.MangaMapper.mapManga
...
class SyncManager(
    ...
    suspend fun syncData() {
        ...
        private fun writeSyncDataToCache(context: Context, backup: Backup): Uri? {
            val cacheFile = File(context.cacheDir, "shinku_sync_data.proto.gz")
            return try {            cacheFile.outputStream().use { output ->
