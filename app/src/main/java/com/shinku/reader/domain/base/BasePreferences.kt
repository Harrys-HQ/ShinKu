package com.shinku.reader.domain.base
...
class BasePreferences(
    ...
    fun highRefreshRate() = preferenceStore.getBoolean("pref_high_refresh_rate", true)

    fun performanceMode() = preferenceStore.getInt("pref_performance_mode", 0)
