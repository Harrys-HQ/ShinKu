package com.shinku.reader.data
...
import com.shinku.reader.view.LibraryView
...
private val mapper = { cursor: SqlCursor ->
    LibraryView(
        ...
        last_metadata_update = cursor.getLong(23)!!,
        version = cursor.getLong(24)!!,
        is_syncing = cursor.getLong(25)!!,
        last_update_error = cursor.getLong(26)!! == 1L,
        notes = cursor.getString(27)!!,
        totalCount = cursor.getLong(28)!!,
        readCount = cursor.getDouble(29)!!,
        latestUpload = cursor.getLong(30)!!,
        chapterFetchedAt = cursor.getLong(31)!!,
        lastRead = cursor.getLong(32)!!,
        bookmarkCount = cursor.getDouble(33)!!,
