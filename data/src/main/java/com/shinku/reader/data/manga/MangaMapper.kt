...
object MangaMapper {
    fun mapManga(
        ...
        lastMetadataUpdate: Long,
        version: Long,
        @Suppress("UNUSED_PARAMETER")
        isSyncing: Long,
        lastUpdateError: Boolean,
        notes: String,
    ): Manga = Manga(
        id = id,
        source = source,
    ...
    fun mapLibraryView(libraryView: LibraryView): LibraryManga {
        return LibraryManga(
            manga = Manga(
                ...
                lastMetadataUpdate = libraryView.last_metadata_update,
                version = libraryView.version,
                lastUpdateError = libraryView.last_update_error,
