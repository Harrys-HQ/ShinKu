package com.shinku.reader.core.metadata.comicinfo
...
data class ComicInfo(
    ...
    // SY -->
    @Serializable
    @XmlSerialName("PaddingShinKu", "http://www.w3.org/2001/XMLSchema", "sk")
    data class PaddingShinKu(@XmlValue(true) val value: String = "")
    // SY <--
}
